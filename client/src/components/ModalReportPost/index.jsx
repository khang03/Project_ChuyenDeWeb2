        ...
        <div className={cx('wrapper')}>
            <div className={cx('wr_modal')}>
                <div className={cx('modal_report_category')}>
                    ...
                    <div onClick={reportContent} className={cx('content_report')}>Nội dung không phù hợp</div>
                    <div onClick={reportCopyRight} className={cx('content_report')}>Vi phạm bản quyền</div>
                </div>
            </div>
        </div>
    );
